...
from finetune.models import BiMCQMedKLIPModule
from finetune.datamodules import NIHBiMCQDataModule
...
if __name__ == "__main__" :
    cfg = OmegaConf.load('./configs/chest14_finetuning_MedKLIP.yaml')
