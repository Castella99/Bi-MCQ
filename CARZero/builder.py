...
def build_BiMCQ_model(cfg):
    CARZero_model = models.BiMCQ_model.BiMCQModel(cfg)
    return CARZero_model
...
def build_mcq_fusion_module(cfg, average_attn_weights=True):
    fusion = models.dqn_wo_self_atten_mlp.Fusion_Module(cfg, average_attn_weights=average_attn_weights)
    return fusion
